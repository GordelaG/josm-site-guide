...
const POLYGONS: PolygonItem[] = [
  {
    ...
    tip: 'Desenhe primeiro, pois engloba toda a área patrimonial do aeródromo.',
  },
  {
    id: 'poly-military',
    category: 'infra',
    ...
    tip: 'Utilize em SBAN, SBAF, SBSC e bases da Força Aérea.',
  },
  {
    id: 'poly-grass',
    category: 'natural',
  ...
  },
  {
    ...
    tip: 'Essencial para aeródromos costeiros, ribeirinhos ou próximos a lagos, baías e reservatórios.',
  },
  {
  ...
  },
  {
    ...
    title: 'Pátios de Concreto (Apron)',
    badge: 'Operacional',
    colorBar: '#717d8a',
    swatch: '#717d8a',
    tags: ['aeroway = apron'],
    desc: 'Área pavimentada em concreto onde aeronaves estacionam, embarcam passageiros e realizam abastecimento.',
    tip: 'Utilize esta tag especificamente para pátios com superfície de concreto.',
  },
  {
    id: 'poly-buildings',
    category: 'infra',
    ...
    desc: 'Todas as edificações: TPS (terminais de passageiros com aeroway = terminal), hangares, TWR e administração.',
    tip: 'Para terminais de passageiros (TPS), utilize a tag aeroway = terminal para diferenciá-los das demais edificações.',
  },
  {
    id: 'poly-runway',
    category: 'operacional',
    ...
    swatch: '#3b82f6',
    tags: ['aeroway = runway'],
    desc: 'Linha do eixo central destinada ao pouso e decolagem de aeronaves, estendendo-se de cabeceira a cabeceira.',
    tip: 'A pista deve ser traçada estritamente como uma linha representando o eixo central (centerline), e não como um retângulo ou polígono fechado.',
  },
  {
    id: 'poly-taxiway',
    category: 'operacional',
  ...
  {
    id: 'poly-holding-position',
    category: 'operacional',
    title: 'Ponto de Espera (Holding Position)',
    badge: 'Operacional',
    colorBar: '#ec4899',
    swatch: '#ec4899',
    tags: ['aeroway = holding_position'],
    desc: 'Ponto de espera ou barra de parada no solo (redlines) antes do acesso à pista de pouso ou área de manobras.',
    tip: 'Deve ser usado para as redlines e pontos de espera dos aeroportos. A holding position deve ser uma linha, não um ponto.',
  },
  {
